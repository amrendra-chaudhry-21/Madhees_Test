...
export const SevenIconQuoteLarge1 = ({ className }) => {
  return (
    <svg
      className={`seven-icon-quote-large-1 ${className}`}
      fill="none"
      height="22"
      viewBox="0 0 22 22"
      width="22"
